...
func (a *TicketAPI) APIs() rpc.APISet {
	return []rpc.MethodInfo{
		...
		},
		{
			...
			Namespace:   constants.NamespaceTicket,
			Func:        a.list,
			Description: "List active validator tickets associated with a proposer",
		},
		{
			Name:        "listHost",
			Namespace:   constants.NamespaceTicket,
			Func:        a.listHost,
			Description: "List active host tickets associated with a proposer",
		},
		{
			Name:        "top",
			Namespace:   constants.NamespaceTicket,
			Func:        a.getTopValidators,
			Description: "Get the top validator tickets",
		},
		{
			Name:        "topHosts",
			Namespace:   constants.NamespaceTicket,
			Func:        a.getTopHosts,
			Description: "Get the top host tickets",
		},
		{
			Name:        "getStats",
			Namespace:   constants.NamespaceTicket,
