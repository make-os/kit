...
// hasSuggestion checks whether a suggest with the given text exists.
...
// add adds a suggestion if it does not already exists.
...
// completer is used to filter the what suggestion to show in the completer
