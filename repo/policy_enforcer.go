...
// PolicyEnforcer provides functionality for enforcing access level policies
// specifically for repositories.
type PolicyEnforcer struct {
	policies policyItems
}

// newPolicyEnforcer creates an instance of PolicyEnforcer; orderedPolicies are a slice
