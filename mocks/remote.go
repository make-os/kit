...
func (m *MockRemoteServer) GetRepo(name string) (plumbing.LocalRepo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetRepo", name)
	ret0, _ := ret[0].(plumbing.LocalRepo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockRemoteServer) GetRepoState(target plumbing.LocalRepo, options ...plumbing.KVOption) (plumbing.RepoRefsState, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(plumbing.RepoRefsState)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
