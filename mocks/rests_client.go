...
// Source: remote/api/client/client.go
...
func (m *MockClient) SendTxPayload(data map[string]interface{}) (*api.SendTxPayloadResponse, error) {
	m.ctrl.T.Helper()
...
func (m *MockClient) GetAccountNonce(address string, blockHeight ...uint64) (*api.GetAccountNonceResponse, error) {
	m.ctrl.T.Helper()
	...
	ret0, _ := ret[0].(*api.GetAccountNonceResponse)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockClient) GetPushKeyOwnerNonce(pushKeyID string, blockHeight ...uint64) (*api.GetAccountNonceResponse, error) {
	m.ctrl.T.Helper()
