...
func (m *MockStoredKey) GetMeta() core.StoredKeyMeta {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetMeta")
	ret0, _ := ret[0].(core.StoredKeyMeta)
	return ret0
}
...
func (m *MockStoredKey) GetPayload() *core.KeyPayload {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetPayload")
	ret0, _ := ret[0].(*core.KeyPayload)
	return ret0
}
...
func (m *MockStoredKey) GetType() core.KeyType {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetType")
	ret0, _ := ret[0].(core.KeyType)
	return ret0
}
...
func (m *MockAccountManager) ListAccounts() ([]core.StoredKey, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListAccounts")
	ret0, _ := ret[0].([]core.StoredKey)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockAccountManager) GetDefault() (core.StoredKey, error) {
	m.ctrl.T.Helper()
...
func (m *MockAccountManager) GetByIndex(i int) (core.StoredKey, error) {
	m.ctrl.T.Helper()
...
func (m *MockAccountManager) GetByIndexOrAddress(idxOrAddr string) (core.StoredKey, error) {
	m.ctrl.T.Helper()
...
func (m *MockAccountManager) GetByAddress(addr string) (core.StoredKey, error) {
	m.ctrl.T.Helper()
...
func (m *MockAccountManager) UIUnlockAccount(addressOrIndex, passphrase string) (core.StoredKey, error) {
	m.ctrl.T.Helper()
