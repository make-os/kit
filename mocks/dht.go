...
func (mr *MockDHTMockRecorder) Announce(ctx, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Announce", reflect.TypeOf((*MockDHT)(nil).Announce), ctx, key)
}

// GetObject mocks base method
func (m *MockDHT) GetObject(ctx context.Context, query *dht.DHTObjectQuery) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockDHT) RegisterObjFinder(objType string, finder dht.ObjectFinder) {
	m.ctrl.T.Helper()
...
// CommitStreamer mocks base method
func (m *MockDHT) CommitStreamer() dht.CommitStreamer {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CommitStreamer")
	ret0, _ := ret[0].(dht.CommitStreamer)
	return ret0
}

// CommitStreamer indicates an expected call of CommitStreamer
func (mr *MockDHTMockRecorder) CommitStreamer() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CommitStreamer", reflect.TypeOf((*MockDHT)(nil).CommitStreamer))
}
