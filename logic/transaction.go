...
func (t *Transaction) exec(tx types.BaseTx, chainHeight uint64) error {
	...
	case *core.TxTicketPurchase:
		...
		if o.Is(core.TxTypeHostTicket) {
			return t.execHostStake(spk, o.Value, o.Fee, chainHeight)
		}
	...
	case *core.TxRepoProposalUpsertOwner:
		return t.execRepoProposalUpsertOwner(spk, o.RepoName, o.ProposalID, o.Addresses,
			o.Veto, o.Value, o.Fee, chainHeight)
	...
	case *core.TxRepoProposalSendFee:
		return t.execRepoProposalFeeDeposit(spk, o.RepoName, o.ProposalID, o.Value, o.Fee, chainHeight)
