...
// 			args := &AddArgs{Config: "path/to/unknown/file"}
// 			err := AddCmd(cfg, args)
...
// 			args := &AddArgs{Account: "1", AccountPass: "pass"}
...
// 			args := &AddArgs{Name: "repo1", Value: "12.2", Fee: "1.2", Account: "1", AccountPass: "pass", Config: `{"governance": {"propFee": "100"}}`}
// 			mockKey := mocks.NewMockStoredKey(ctrl)
// 			mockKey.EXPECT().GetAddress().Return(key.Addr().String())
