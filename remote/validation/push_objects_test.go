...
var _ = Describe("Validation", func() {
	...
	Describe(".CheckPushNoteSanity", func() {
		...
		var cases = [][]interface{}{
			...
			{&types.Note{RepoName: "repo", PushKeyID: pkID, Timestamp: now, PusherAcctNonce: 1, CreatorPubKey: nodePubKey, RemoteNodeSig: okSig, Size: 100, FromRemotePeer: true}, "field:size, msg:size does not match local size"},
			{&types.Note{RepoName: "repo", PushKeyID: pkID, Timestamp: now, PusherAcctNonce: 1, CreatorPubKey: nodePubKey, RemoteNodeSig: okSig, LocalSize: 100, FromRemotePeer: true}, "field:size, msg:size does not match local size"},
