...
var _ = Describe("Repo", func() {
	...
	Describe(".GetBranches", func() {
		...
		It("should return expected branches", func() {
			...
			Expect(err).To(BeNil())
			Expect(branches).To(Equal([]string{"dev", "master"}))
		})
	})
	...
	Describe(".GetParentAndChildCommitDiff", func() {
		It("should return expected patch output", func() {
			...
			Expect(res.Patches[0]).To(HaveKey("a77021f4aead5f5ab8934a94154b0b4da6a551b5"))
			Expect(res.Patches[0]["a77021f4aead5f5ab8934a94154b0b4da6a551b5"]).To(Equal(`diff --git a/file_b.txt b/file_b.txt
