...
genmocks:
	...
	mockgen -source=dht/commit_requester.go -destination=mocks/dht_commit_requester.go -package mocks && \
	mockgen -source=dht/commit_streamer.go -destination=mocks/dht_commit_streamer.go -package mocks && \
