...
//go:generate minimock -i github.com/makeos/mosdef/mosdb.Tx -o ./mocks/tx_mock.go
...
type TxMock struct {
	...
	funcIterate          func(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool)
...
// NewTxMock returns a mock for mosdb.Tx
...
// DeleteByPrefix implements mosdb.Tx
...
func (mmGetByPrefix *mTxMockGetByPrefix) Return(result []*mm_mosdb.KVObject) *TxMock {
	if mmGetByPrefix.mock.funcGetByPrefix != nil {
		mmGetByPrefix.mock.t.Fatalf("TxMock.GetByPrefix mock is already set by Set")
	}
...
func (mmGetByPrefix *mTxMockGetByPrefix) Set(f func(ba1 []byte) (result []*mm_mosdb.KVObject)) *TxMock {
	if mmGetByPrefix.defaultExpectation != nil {
...
func (e *TxMockGetByPrefixExpectation) Then(result []*mm_mosdb.KVObject) *TxMock {
	e.results = &TxMockGetByPrefixResults{result}
	return e.mock
}

// GetByPrefix implements mosdb.Tx
func (mmGetByPrefix *TxMock) GetByPrefix(ba1 []byte) (result []*mm_mosdb.KVObject) {
...
func (mmIterate *mTxMockIterate) Expect(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool) *mTxMockIterate {
...
func (mmIterate *mTxMockIterate) Inspect(f func(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool)) *mTxMockIterate {
...
func (mmIterate *mTxMockIterate) Set(f func(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool)) *TxMock {
	if mmIterate.defaultExpectation != nil {
...
// Iterate implements mosdb.Tx
func (mmIterate *TxMock) Iterate(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool) {
...
func (mmPut *mTxMockPut) Expect(kpa1 []*mm_mosdb.KVObject) *mTxMockPut {
...
func (mmPut *mTxMockPut) Inspect(f func(kpa1 []*mm_mosdb.KVObject)) *mTxMockPut {
...
func (mmPut *mTxMockPut) Set(f func(kpa1 []*mm_mosdb.KVObject) (err error)) *TxMock {
	if mmPut.defaultExpectation != nil {
...
// Then helper
func (mmPut *mTxMockPut) When(kpa1 []*mm_mosdb.KVObject) *TxMockPutExpectation {
	if mmPut.mock.funcPut != nil {
		mmPut.mock.t.Fatalf("TxMock.Put mock is already set by Set")
	}
...
// Put implements mosdb.Tx
func (mmPut *TxMock) Put(kpa1 []*mm_mosdb.KVObject) (err error) {
