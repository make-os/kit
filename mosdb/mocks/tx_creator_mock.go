...
//go:generate minimock -i github.com/makeos/mosdef/mosdb.TxCreator -o ./mocks/tx_creator_mock.go
...
// TxCreatorMock implements mosdb.TxCreator
...
// NewTxCreatorMock returns a mock for mosdb.TxCreator
...
func (mmNewTx *mTxCreatorMockNewTx) Return(t1 mm_mosdb.Tx, err error) *TxCreatorMock {
	if mmNewTx.mock.funcNewTx != nil {
		mmNewTx.mock.t.Fatalf("TxCreatorMock.NewTx mock is already set by Set")
	}
...
func (mmNewTx *mTxCreatorMockNewTx) Set(f func() (t1 mm_mosdb.Tx, err error)) *TxCreatorMock {
	if mmNewTx.defaultExpectation != nil {
...
// NewTx implements mosdb.TxCreator
func (mmNewTx *TxCreatorMock) NewTx() (t1 mm_mosdb.Tx, err error) {
