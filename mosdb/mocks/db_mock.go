...
//go:generate minimock -i github.com/makeos/mosdef/mosdb.DB -o ./mocks/db_mock.go
...
import (
	...
	mm_mosdb "github.com/makeos/mosdef/mosdb"
)

// DBMock implements mosdb.DB
type DBMock struct {
	t minimock.Tester
	...
	funcGetByPrefix          func(ba1 []byte) (result []*mm_mosdb.KVObject)
	...
	funcGetFirstOrLast          func(prefix []byte, first bool) (kp1 *mm_mosdb.KVObject)
	...
	funcIterate          func(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool) (err error)
	inspectFuncIterate   func(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool)
	afterIterateCounter  uint64
	beforeIterateCounter uint64
	IterateMock          mDBMockIterate

	funcNewTx          func() (t1 mm_mosdb.Tx, err error)
	...
	funcPut          func(kpa1 []*mm_mosdb.KVObject) (err error)
	inspectFuncPut   func(kpa1 []*mm_mosdb.KVObject)
	...
	funcTruncateWithFunc          func(prefix []byte, first bool, predicate func(kv *mm_mosdb.KVObject) bool) (err error)
	inspectFuncTruncateWithFunc   func(prefix []byte, first bool, predicate func(kv *mm_mosdb.KVObject) bool)
	afterTruncateWithFuncCounter  uint64
	beforeTruncateWithFuncCounter uint64
	TruncateWithFuncMock          mDBMockTruncateWithFunc
}

// NewDBMock returns a mock for mosdb.DB
...
// DeleteByPrefix implements mosdb.DB
...
func (mmGetByPrefix *mDBMockGetByPrefix) Return(result []*mm_mosdb.KVObject) *DBMock {
	if mmGetByPrefix.mock.funcGetByPrefix != nil {
		mmGetByPrefix.mock.t.Fatalf("DBMock.GetByPrefix mock is already set by Set")
	}
...
func (mmGetByPrefix *mDBMockGetByPrefix) Set(f func(ba1 []byte) (result []*mm_mosdb.KVObject)) *DBMock {
	if mmGetByPrefix.defaultExpectation != nil {
...
func (e *DBMockGetByPrefixExpectation) Then(result []*mm_mosdb.KVObject) *DBMock {
	e.results = &DBMockGetByPrefixResults{result}
	return e.mock
}

// GetByPrefix implements mosdb.DB
func (mmGetByPrefix *DBMock) GetByPrefix(ba1 []byte) (result []*mm_mosdb.KVObject) {
...
func (mmGetFirstOrLast *mDBMockGetFirstOrLast) Return(kp1 *mm_mosdb.KVObject) *DBMock {
	if mmGetFirstOrLast.mock.funcGetFirstOrLast != nil {
		mmGetFirstOrLast.mock.t.Fatalf("DBMock.GetFirstOrLast mock is already set by Set")
	}
...
func (mmGetFirstOrLast *mDBMockGetFirstOrLast) Set(f func(prefix []byte, first bool) (kp1 *mm_mosdb.KVObject)) *DBMock {
	if mmGetFirstOrLast.defaultExpectation != nil {
...
func (e *DBMockGetFirstOrLastExpectation) Then(kp1 *mm_mosdb.KVObject) *DBMock {
	e.results = &DBMockGetFirstOrLastResults{kp1}
	return e.mock
}

// GetFirstOrLast implements mosdb.DB
func (mmGetFirstOrLast *DBMock) GetFirstOrLast(prefix []byte, first bool) (kp1 *mm_mosdb.KVObject) {
...
type DBMockIterateParams struct {
	prefix   []byte
	first    bool
	iterFunc func(kv *mm_mosdb.KVObject) bool
}
...
func (mmIterate *mDBMockIterate) Expect(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool) *mDBMockIterate {
...
func (mmIterate *mDBMockIterate) Inspect(f func(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool)) *mDBMockIterate {
...
func (mmIterate *mDBMockIterate) Set(f func(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool) (err error)) *DBMock {
	if mmIterate.defaultExpectation != nil {
...
// Then helper
func (mmIterate *mDBMockIterate) When(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool) *DBMockIterateExpectation {
	if mmIterate.mock.funcIterate != nil {
		mmIterate.mock.t.Fatalf("DBMock.Iterate mock is already set by Set")
	}
...
// Iterate implements mosdb.DB
func (mmIterate *DBMock) Iterate(prefix []byte, first bool, iterFunc func(kv *mm_mosdb.KVObject) bool) (err error) {
...
func (mmNewTx *mDBMockNewTx) Return(t1 mm_mosdb.Tx, err error) *DBMock {
	if mmNewTx.mock.funcNewTx != nil {
		mmNewTx.mock.t.Fatalf("DBMock.NewTx mock is already set by Set")
	}
...
func (mmNewTx *mDBMockNewTx) Set(f func() (t1 mm_mosdb.Tx, err error)) *DBMock {
	if mmNewTx.defaultExpectation != nil {
...
// NewTx implements mosdb.DB
func (mmNewTx *DBMock) NewTx() (t1 mm_mosdb.Tx, err error) {
...
func (mmPut *mDBMockPut) Expect(kpa1 []*mm_mosdb.KVObject) *mDBMockPut {
...
func (mmPut *mDBMockPut) Inspect(f func(kpa1 []*mm_mosdb.KVObject)) *mDBMockPut {
...
func (mmPut *mDBMockPut) Set(f func(kpa1 []*mm_mosdb.KVObject) (err error)) *DBMock {
	if mmPut.defaultExpectation != nil {
...
// Then helper
func (mmPut *mDBMockPut) When(kpa1 []*mm_mosdb.KVObject) *DBMockPutExpectation {
	if mmPut.mock.funcPut != nil {
		mmPut.mock.t.Fatalf("DBMock.Put mock is already set by Set")
	}
...
// Put implements mosdb.DB
func (mmPut *DBMock) Put(kpa1 []*mm_mosdb.KVObject) (err error) {
...
type DBMockTruncateWithFuncParams struct {
	prefix    []byte
	first     bool
	predicate func(kv *mm_mosdb.KVObject) bool
}
...
func (mmTruncateWithFunc *mDBMockTruncateWithFunc) Expect(prefix []byte, first bool, predicate func(kv *mm_mosdb.KVObject) bool) *mDBMockTruncateWithFunc {
...
func (mmTruncateWithFunc *mDBMockTruncateWithFunc) Inspect(f func(prefix []byte, first bool, predicate func(kv *mm_mosdb.KVObject) bool)) *mDBMockTruncateWithFunc {
...
func (mmTruncateWithFunc *mDBMockTruncateWithFunc) Set(f func(prefix []byte, first bool, predicate func(kv *mm_mosdb.KVObject) bool) (err error)) *DBMock {
	if mmTruncateWithFunc.defaultExpectation != nil {
...
// Then helper
func (mmTruncateWithFunc *mDBMockTruncateWithFunc) When(prefix []byte, first bool, predicate func(kv *mm_mosdb.KVObject) bool) *DBMockTruncateWithFuncExpectation {
	if mmTruncateWithFunc.mock.funcTruncateWithFunc != nil {
		mmTruncateWithFunc.mock.t.Fatalf("DBMock.TruncateWithFunc mock is already set by Set")
	}
...
// TruncateWithFunc implements mosdb.DB
func (mmTruncateWithFunc *DBMock) TruncateWithFunc(prefix []byte, first bool, predicate func(kv *mm_mosdb.KVObject) bool) (err error) {
