...
func TestConvertSeedToKey(t *testing.T) {
	seed := util.RandBytes(32)
	sk, err := GenerateKeyFromSeed(seed)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGenerateKeyFromSeedWithLessThan32BytesSeed(t *testing.T) {
	seed := util.RandBytes(20)
	_, err := GenerateKeyFromSeed(seed)
	if err == nil {
		t.Fatal(err)
	}
}

func TestConvert64ByteSeedToKey(t *testing.T) {
	seed := util.RandBytes(64)
	sk, err := GenerateKeyFromPrivateKey(seed)
	if err != nil {
		t.Fatal(err)
	}
...
func TestGenerateKeyFromPrivateKeyWithLessThan62BytesSeed(t *testing.T) {
	seed := util.RandBytes(20)
	_, err := GenerateKeyFromPrivateKey(seed)
	if err == nil {
		t.Fatal(err)
	}
}
